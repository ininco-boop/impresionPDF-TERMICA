...
function construirImagenRecibo(texto, qrContenido) {
  ...
  ctxTmp.font = fontSize + "px 'Courier New', monospace";
  ...
  const topTextHeight = lineasFinales.length * lineHeight + 16;
  const qrLabelHeight = 50;
  const totalHeight = topTextHeight + qrPixelSize + qrLabelHeight + 24;
  ...
  ctx.fillText("en la DGI", width / 2, y + 20);
